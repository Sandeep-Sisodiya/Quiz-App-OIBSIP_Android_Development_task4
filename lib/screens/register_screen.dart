                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text('Register', style: GoogleFonts.orbitron(textStyle: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                          ),
                        ),
                        const SizedBox(height: 12),
                        TextButton(
                          onPressed: () => PageTransitions.slideL(context, LoginScreen()),
